...
// Do not add arbitrary shadow or drop-shadow values for surface
...
// - ProductCard/ProductPage/CollectionPage bottle `drop-shadow-xl`: a CSS
...
// - ProductCard image-well inset ambient shadow:
//   occlusion effect inside the photography stage, not a raised/elevated surface.
// - ProductPage mobile sticky add-to-cart bar:
