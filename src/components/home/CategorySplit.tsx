...
const CategoryBlock: React.FC<CategoryBlockProps> = ({ title, subtitle, image, href, className }) => {
  return (
    <motion.a
      href={href}
      initial={{ opacity: 0 }}
      ...
      viewport={{ once: true }}
      className={cn("group relative flex-1 h-[60vh] md:h-[80vh] overflow-hidden bg-neutral-900 cursor-pointer flex items-center justify-center", className)}
    >
  ...
  return (
    <section className="bg-brand-black flex flex-col md:flex-row w-full overflow-hidden">
      <CategoryBlock 
        ...
        image="/images/campaign/men-collection.webp"
        href="/collection/men"
      />
      ...
      <CategoryBlock 
        title="Pour Femme" 
        subtitle="The Muse" 
        image="/images/campaign/women-collection.webp"
